...
export default function ImageGenerator() {
  ...
  const [activeSubMenu, setActiveSubMenu] = useState<'main' | 'aspectRatio' | 'quality' | 'style'>('main');
  ...
  // 新增：模型选择状态
  const [selectedModel, setSelectedModel] = useState('nano banana2');
  const [isModelDropdownOpen, setIsModelDropdownOpen] = useState(false);
  const imageModels = ['nano banana2', 'nano banana pro', 'image-2'];
                                        ...
                                        <div className="absolute top-full left-0 mt-2 w-64 bg-[#1a0f14]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden z-50 animate-fade-in">
                                            ...
                                            {activeSubMenu === 'main' && (
                                                <div className="p-2 space-y-1">
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-3 text-sm">
                                                            <Icon name="Palette" className="w-4 h-4 text-white/50 group-hover:text-white" />
                                                            图片风格
                                                        </div>
                                                        <div className="flex items-center gap-2 text-sm text-white/50">
                                                            {imageSettings.style}
                                            ...
                                            {activeSubMenu === 'aspectRatio' && (
                                                <div>
                                                    <div className="flex items-center gap-2 p-3 border-b border-white/5">
                                                        ...
                                                        <span className="text-xs font-bold text-white/50 tracking-widest">图片尺寸</span>
                                                    </div>
                                                    <div className="p-2 grid grid-cols-2 gap-1">
                                                        {['Auto', '16:9', '9:16', '4:3', '3:4', '1:1', '21:9'].map(ratio => (
                                                            <button
                                                                key={ratio}
                                                                onClick={() => {
                                                                    setImageSettings({...imageSettings, aspectRatio: ratio});
                                                                    setActiveSubMenu('main');
                                                                }}
                                                                className={`flex items-center gap-2 p-3 rounded-xl text-sm transition-colors ${imageSettings.aspectRatio === ratio ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/5 hover:text-white'}`}
                                                            >
                                            ...
                                            {activeSubMenu === 'quality' && (
                                                <div>
                                                    <div className="flex items-center gap-2 p-3 border-b border-white/5">
                                                        ...
                                                        <span className="text-xs font-bold text-white/50 tracking-widest">图片分辨率</span>
                                                    </div>
                                                    <div className="p-2 space-y-1">
                                                        {['1080p', '2k', '4k', '8k'].map(quality => (
                                                            <button
                                                                key={quality}
                                                                onClick={() => {
                                                                    setImageSettings({...imageSettings, quality});
                                                                    setActiveSubMenu('main');
                                                                }}
                                                                className={`w-full flex items-center justify-between p-3 rounded-xl text-sm transition-colors ${imageSettings.quality === quality ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/5 hover:text-white'}`}
                                                            >
                                                                {quality}
                                                                {imageSettings.quality === quality && <Icon name="Check" className="w-4 h-4 text-[#FF2A6D]" />}
                                                            </button>
                                                        ))}
                                                    </div>
                                                </div>
                                            ...
                                            {activeSubMenu === 'style' && (
                                                <div>
                                                    <div className="flex items-center gap-2 p-3 border-b border-white/5">
                                                        ...
                                                        <span className="text-xs font-bold text-white/50 tracking-widest">图片风格</span>
                                                    </div>
                                                    <div className="p-2 space-y-1">
                                                        {['写实摄影', '3D渲染', '插画', '动漫', '赛博朋克'].map(style => (
                                                            <button
                                                                key={style}
                                                                onClick={() => {
                                                                    setImageSettings({...imageSettings, style});
                                                                    setActiveSubMenu('main');
                                                                }}
                                                                className={`w-full flex items-center justify-between p-3 rounded-xl text-sm transition-colors ${imageSettings.style === style ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/5 hover:text-white'}`}
                                                            >
                                                                {style}
                                                                {imageSettings.style === style && <Icon name="Check" className="w-4 h-4 text-[#FF2A6D]" />}
                                                            </button>
                                                        ))}
                                                    </div>
                                                </div>
                    ...
                    <div className="bg-[#1a0f14]/95 border border-white/10 rounded-3xl w-full max-w-5xl max-h-[85vh] flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.5)] animate-slide-up overflow-hidden relative">
                        ...
                        <div className="flex items-center justify-between p-6 md:p-8 border-b border-white/5 shrink-0">
                            <div>
                                ...
                                <p className="text-white/50 text-sm">选择适合您的产品和受众的图像内容类型。</p>
                            </div>
                            <button 
                    ...
                    <div className="bg-[#1a0f14]/95 border border-white/10 rounded-3xl w-full max-w-5xl max-h-[85vh] flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.5)] animate-slide-up overflow-hidden relative">
                        ...
                        <div className="flex items-center justify-between p-6 md:p-8 border-b border-white/5 shrink-0">
                            <div>
                                ...
                                <p className="text-white/50 text-sm">选择故事发生的地方。挑选一个能为您的广告图片营造合适氛围的场景。</p>
                            </div>
                            <button 
                    ...
                    <div className="bg-[#1a0f14]/95 border border-white/10 rounded-3xl w-full max-w-5xl max-h-[85vh] flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.5)] animate-slide-up overflow-hidden relative">
                        ...
                        <div className="flex items-center justify-between p-6 md:p-8 border-b border-white/5 shrink-0">
                            <div>
                                ...
                                <p className="text-white/50 text-sm">选择一个经过验证的视觉吸引点，让您的图片脱颖而出。</p>
                            </div>
                            <button 
